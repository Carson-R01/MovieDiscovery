 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ga{constructor(e,n,s,r,i){this.snapshotVersion=e,this.targetChanges=n,this.targetMismatches=s,this.documentUpdates=r,this.resolvedLimboDocuments=i}static createSynthesizedRemoteEventForCurrentChange(e,n,s){const r=new Map;return r.set(e,Qa.createSynthesizedTargetChangeForCurrentChange(e,n,s)),new Ga(Ae.min(),r,new gt(Le),rr(),Fe())}}class Qa{constructor(e,n,s,r,i){this.resumeToken=e,this.current=n,this.addedDocuments=s,this.modifiedDocuments=r,this.removedDocuments=i}static createSynthesizedTargetChangeForCurrentChange(e,n,s){return new Qa(s,n,Fe(),Fe(),Fe())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */vn.DEFAULT_COLLECTION_PERCENTILE=10,vn.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT=1e3,vn.DEFAULT=new vn(yy,vn.DEFAULT_COLLECTION_PERCENTILE,vn.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT),vn.DISABLED=new vn(-1,0,0);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Dr(kP,DP,"app");const aa={apiKey:"AIzaSyCEDVal9uLQ_bJLij6M2PFA3MWuiA0uCfU",authDomain:"moviediscovery-75a03.firebaseapp.com",projectId:"moviediscovery-75a03",storageBucket:"moviediscovery-75a03.firebasestorage.app",messagingSenderId:"967866909978",appId:"1:967866909978:web:8025ff7d7ebf52011ed8a3",measurementId:"G-0HQ1X88MBB"},OP=!!(aa.apiKey&&aa.authDomain&&aa.projectId&&aa.appId),xa=OP?Bm(aa):null,Po=!!xa,Cf=xa?XS(xa):null,Rf=xa?uP(xa):null,NP=new Ks;function xP(t){return Po?jA(Cf,t):(t(null),()=>{})}async function VP(){if(!Po)throw new Error("Firebase is not configured");await aS(Cf,NP)}async function MP(){Po&&await $A(Cf)}async function LP(t){return!Po||!t?[]:(await CP(cP(Rf,"users",t,"watchlist"))).docs.map(n=>n.data())}async function FP(t,e){var n;!Po||!t||await RP($y(Rf,"users",t,"watchlist",String(e.id)),{id:e.id,title:e.title,overview:e.overview||"",poster_path:e.poster_path||"",backdrop_path:e.backdrop_path||"",posterUrl:e.posterUrl||"",backdropUrl:e.backdropUrl||"",release_date:e.release_date||"",vote_average:e.vote_average||0,genre_ids:e.genre_ids||((n=e.genres)==null?void 0:n.map(s=>s.id))||[],year:e.year||"",rating:e.rating||"NR",addedAt:TP()})}async function UP(t,e){!Po||!t||await PP($y(Rf,"users",t,"watchlist",String(e)))}const jP={class:"hero-overlay"},$P={class:"container py-4 d-flex align-items-center justify-content-between gap-3"},BP={class:"nav-actions"},HP={key:1,class:"account-pill"},qP=["src","alt"],WP={class:"badge text-bg-dark ms-1"},zP={class:"container hero-content"},KP={class:"hero-copy"},GP={class:"content-band"},QP={class:"container py-4 py-lg-5"},JP={class:"toolbar mb-4"},YP=["value"],XP={key:0,class:"alert alert-warning auth-alert",role:"alert"},ZP={class:"d-flex align-items-end justify-content-between gap-3 mb-3"},ek={class:"section-kicker mb-1"},tk={class:"h3 mb-0"},nk={key:1,class:"loading-state"},sk={key:2,class:"empty-state"},rk={key:3,class:"row g-4"},ik={key:4,class:"recommendations-section"},ok={key:0,class:"loading-state compact-state"},ak={key:1,class:"empty-state compact-state"},lk={key:2,class:"row g-4"},ck={key:0,class:"detail-page"},uk={class:"container py-5"},hk={class:"row g-4 align-items-start"},fk={class:"col-md-4 col-lg-3"},dk=["src","alt"],pk={class:"col-md-8 col-lg-9"},gk={class:"detail-meta mb-3"},mk={class:"badge text-bg-warning"},_k={key:0},yk={class:"display-5 fw-bold"},vk={class:"lead text-secondary"},wk={class:"d-flex flex-wrap gap-2 mb-4"},Ek={key:0,class:"cast-section mt-5"},Tk={class:"cast-grid"},bk=["onClick"],Ik=["src","alt"],Ak={key:1,class:"cast-photo cast-photo-placeholder"},Sk={class:"cast-copy"},Ck={key:1,class:"profile-page"},Rk={class:"container py-5"},Pk={key:0,class:"loading-state"},kk={key:1,class:"row g-4 align-items-start"},Dk={class:"col-md-4 col-lg-3"},Ok=["src","alt"],Nk={key:1,class:"profile-photo-placeholder"},xk={class:"col-md-8 col-lg-9"},Vk={class:"detail-meta mb-3"},Mk={key:0},Lk={key:1},Fk={class:"display-5 fw-bold"},Uk={class:"lead text-secondary profile-bio"},jk={class:"profile-credits mt-5"},$k={key:0,class:"empty-state compact-state"},Bk={key:1,class:"row g-4"},Hk={__name:"App",setup(t){const e=mn([]),n=mn([]),s=mn(JSON.parse(localStorage.getItem("movie-watchlist")||"[]")),r=mn(null),i=mn(""),a=mn(""),c=mn(null),u=mn(null),d=mn(!0),g=mn(""),y=mn(!1),A=mn([]),O=mn(!1),$=mn("home");let B=0,Q=0,se=null;const Y=Ir(()=>e.value[0]),ae=Ir(()=>$.value==="watchlist"?s.value:e.value),ue=Ir(()=>a.value?ae.value.filter(he=>{var et;return(he.genre_ids||((et=he.genres)==null?void 0:et.map(ee=>ee.id))||[]).includes(Number(a.value))}):ae.value),De=Ir(()=>$.value==="watchlist"?"Your Watchlist":i.value?`Results for "${i.value}"`:"Trending Movies"),Je=Ir(()=>c.value?c.value.genres?c.value.genres:n.value.filter(he=>{var te;return(te=c.value.genre_ids)==null?void 0:te.includes(he.id)}):[]),S=Ir(()=>{var he,te,et;return((et=(te=(he=c.value)==null?void 0:he.credits)==null?void 0:te.cast)==null?void 0:et.slice(0,12))||[]}),w=Ir(()=>{var te,et;const he=new Set;return(((et=(te=u.value)==null?void 0:te.movieCredits)==null?void 0:et.cast)||[]).filter(ee=>ee.posterUrl).filter(ee=>he.has(ee.id)?!1:(he.add(ee.id),!0)).sort((ee,jt)=>{const Se=ee.release_date||"";return(jt.release_date||"").localeCompare(Se)}).slice(0,18)});function b(){localStorage.setItem("movie-watchlist",JSON.stringify(s.value))}function C(he){return s.value.some(te=>te.id===he)}async function I(he){var te,et;if(g.value="",C(he.id)){s.value=s.value.filter(ee=>ee.id!==he.id);try{await UP((te=r.value)==null?void 0:te.uid,he.id)}catch(ee){g.value=ee.message||"Unable to update your account watchlist."}}else{s.value=[he,...s.value];try{await FP((et=r.value)==null?void 0:et.uid,he)}catch(ee){g.value=ee.message||"Unable to update your account watchlist."}}r.value||b(),qe()}async function D(){g.value="";try{await VP()}catch(he){g.value=he.message||"Unable to sign in."}}async function T(){g.value="";try{await MP()}catch(he){g.value=he.message||"Unable to sign out."}}async function mt(he){if(r.value=he,g.value="",!he){$.value==="watchlist"&&($.value="home"),s.value=JSON.parse(localStorage.getItem("movie-watchlist")||"[]"),qe();return}try{const te=await LP(he.uid);s.value=te,qe()}catch(te){g.value=te.message||"Unable to load your account watchlist."}}function zt(he=""){return he.split(" ").filter(Boolean).slice(0,2).map(te=>te[0]).join("").toUpperCase()}async function _t(){d.value=!0,$.value="home",c.value=null,e.value=await pb(i.value),d.value=!1}async function qe(){const he=++B;if(!s.value.length){A.value=[],O.value=!1;return}O.value=!0;const te=await mb(s.value);he===B&&(A.value=te,O.value=!1)}async function xe(he){const te=await tp(he.id);c.value=te||he,u.value=null,window.history.pushState({},"",`#movie-${he.id}`)}async function Kt(he){await xe(he),u.value=null}async function Fn(he){const te=++Q;y.value=!0,u.value=null;const et=await _b(he.id);te===Q&&(u.value=et||{...he,biography:"No profile available.",movieCredits:{cast:[]}},y.value=!1)}function L(){u.value=null,y.value=!1}function Pt(){c.value=null,u.value=null,window.history.pushState({},"",window.location.pathname)}function es(){$.value="watchlist",c.value=null,u.value=null,window.history.pushState({},"",window.location.pathname)}function wn(){$.value="home",c.value=null,u.value=null,window.history.pushState({},"",window.location.pathname)}async function kt(){const he=window.location.hash.match(/^#movie-(\d+)$/);if(!he){c.value=null,u.value=null;return}const te=await tp(he[1]);c.value=te}return om(async()=>{se=xP(mt);const[he,te]=await Promise.all([Om(),gb()]);e.value=he,n.value=te,d.value=!1,qe(),await kt(),window.addEventListener("popstate",kt)}),Nh(()=>{se==null||se(),window.removeEventListener("popstate",kt)}),(he,te)=>{var et,ee,jt;return Ee(),Ie("main",null,[oe("section",{class:"hero",style:Tc({backgroundImage:(et=Y.value)!=null&&et.backdropUrl?`url(${Y.value.backdropUrl})`:""})},[oe("div",jP,[oe("nav",$P,[oe("button",{class:"brand-button",type:"button",onClick:wn},"Movie Discovery"),oe("div",BP,[r.value?(Ee(),Ie("div",HP,[r.value.photoURL?(Ee(),Ie("img",{key:0,class:"account-avatar",src:r.value.photoURL,alt:r.value.displayName||r.value.email},null,8,qP)):_n("",!0),oe("span",null,Ze(r.value.displayName||r.value.email),1),oe("button",{class:"btn btn-sm btn-outline-light",type:"button",onClick:T},"Sign out")])):(Ee(),Ie("button",{key:0,class:"btn btn-outline-light",type:"button",onClick:D}," Sign in ")),r.value?(Ee(),Ie("button",{key:2,class:"btn btn-warning",type:"button",onClick:es},[te[4]||(te[4]=Cm(" Watchlist ",-1)),oe("span",WP,Ze(s.value.length),1)])):_n("",!0)])]),oe("div",zP,[te[5]||(te[5]=oe("p",{class:"text-warning fw-semibold mb-2"},"Trending this week",-1)),oe("h1",null,Ze(((ee=Y.value)==null?void 0:ee.title)||"Discover your next movie"),1),oe("p",KP,Ze(((jt=Y.value)==null?void 0:jt.overview)||"Search, filter, rate, and save movies with TMDB data."),1),Y.value?(Ee(),Ie("button",{key:0,class:"btn btn-light btn-lg",type:"button",onClick:te[0]||(te[0]=Se=>xe(Y.value))}," View Details ")):_n("",!0)])])],4),oe("section",GP,[oe("div",QP,[oe("div",JP,[oe("form",{class:"search-form",onSubmit:BT(_t,["prevent"])},[Id(oe("input",{"onUpdate:modelValue":te[1]||(te[1]=Se=>i.value=Se),class:"form-control form-control-lg",type:"search",placeholder:"Search movies","aria-label":"Search movies"},null,512),[[FT,i.value]]),te[6]||(te[6]=oe("button",{class:"btn btn-warning btn-lg",type:"submit"},"Search",-1))],32),Id(oe("select",{"onUpdate:modelValue":te[2]||(te[2]=Se=>a.value=Se),class:"form-select form-select-lg genre-select","aria-label":"Filter by genre"},[te[7]||(te[7]=oe("option",{value:""},"All genres",-1)),(Ee(!0),Ie(fn,null,Ki(n.value,Se=>(Ee(),Ie("option",{key:Se.id,value:Se.id},Ze(Se.name),9,YP))),128))],512),[[UT,a.value]])]),g.value?(Ee(),Ie("div",XP,Ze(g.value),1)):_n("",!0),oe("div",ZP,[oe("div",null,[oe("p",ek,Ze($.value==="watchlist"?"Saved picks":"Browse"),1),oe("h2",tk,Ze(De.value),1)]),$.value==="watchlist"?(Ee(),Ie("button",{key:0,class:"btn btn-outline-light",type:"button",onClick:wn}," Back to Movies ")):_n("",!0)]),d.value?(Ee(),Ie("div",nk,"Loading movies...")):ue.value.length===0?(Ee(),Ie("div",sk," No movies found. Try another search or genre. ")):(Ee(),Ie("div",rk,[(Ee(!0),Ie(fn,null,Ki(ue.value,Se=>(Ee(),Ie("div",{key:Se.id,class:"col-6 col-md-4 col-lg-3 col-xl-2"},[Ln(Au,{movie:Se,"is-watchlisted":C(Se.id),onSelect:xe,onToggleWatchlist:I},null,8,["movie","is-watchlisted"])]))),128))])),s.value.length?(Ee(),Ie("div",ik,[te[8]||(te[8]=oe("div",{class:"d-flex align-items-end justify-content-between gap-3 mb-3"},[oe("div",null,[oe("p",{class:"section-kicker mb-1"},"For your watchlist"),oe("h2",{class:"h3 mb-0"},"Recommended Movies")])],-1)),O.value?(Ee(),Ie("div",ok,"Finding similar movies...")):A.value.length===0?(Ee(),Ie("div",ak," Add a few more movies to improve recommendations. ")):(Ee(),Ie("div",lk,[(Ee(!0),Ie(fn,null,Ki(A.value,Se=>(Ee(),Ie("div",{key:Se.id,class:"col-6 col-md-4 col-lg-3 col-xl-2"},[Ln(Au,{movie:Se,"is-watchlisted":C(Se.id),onSelect:xe,onToggleWatchlist:I},null,8,["movie","is-watchlisted"])]))),128))]))])):_n("",!0)])]),c.value?(Ee(),Ie("section",ck,[oe("div",uk,[oe("button",{class:"btn btn-outline-light mb-4",type:"button",onClick:Pt},"Back"),oe("div",hk,[oe("div",fk,[c.value.posterUrl?(Ee(),Ie("img",{key:0,class:"detail-poster",src:c.value.posterUrl,alt:c.value.title},null,8,dk)):_n("",!0)]),oe("div",pk,[oe("div",gk,[oe("span",mk,Ze(c.value.rating),1),oe("span",null,Ze(c.value.year),1),c.value.runtime?(Ee(),Ie("span",_k,Ze(c.value.runtime)+" min",1)):_n("",!0)]),oe("h2",yk,Ze(c.value.title),1),oe("p",vk,Ze(c.value.overview),1),oe("div",wk,[(Ee(!0),Ie(fn,null,Ki(Je.value,Se=>(Ee(),Ie("span",{key:Se.id,class:"badge rounded-pill text-bg-secondary"},Ze(Se.name),1))),128))]),oe("button",{class:Ma(["btn btn-lg",C(c.value.id)?"btn-success":"btn-warning"]),type:"button",onClick:te[3]||(te[3]=Se=>I(c.value))},Ze(C(c.value.id)?"Remove from Watchlist":"Add to Watchlist"),3),S.value.length?(Ee(),Ie("div",Ek,[te[9]||(te[9]=oe("div",{class:"d-flex align-items-end justify-content-between gap-3 mb-3"},[oe("div",null,[oe("h3",{class:"mb-1"},"Cast")])],-1)),oe("div",Tk,[(Ee(!0),Ie(fn,null,Ki(S.value,Se=>(Ee(),Ie("button",{key:Se.cast_id||Se.credit_id||Se.id,class:"cast-card",type:"button",onClick:E=>Fn(Se)},[Se.profileUrl?(Ee(),Ie("img",{key:0,class:"cast-photo",src:Se.profileUrl,alt:Se.name},null,8,Ik)):(Ee(),Ie("div",Ak,Ze(zt(Se.name)),1)),oe("div",Sk,[oe("h4",null,Ze(Se.name),1),oe("p",null,Ze(Se.character||"Cast member"),1)])],8,bk))),128))])])):_n("",!0)])])])])):_n("",!0),u.value||y.value?(Ee(),Ie("section",Ck,[oe("div",Rk,[oe("button",{class:"btn btn-outline-light mb-4",type:"button",onClick:L},"Back to Movie"),y.value?(Ee(),Ie("div",Pk,"Loading profile...")):u.value?(Ee(),Ie("div",kk,[oe("div",Dk,[u.value.profileUrl?(Ee(),Ie("img",{key:0,class:"detail-poster",src:u.value.profileUrl,alt:u.value.name},null,8,Ok)):(Ee(),Ie("div",Nk,Ze(zt(u.value.name)),1))]),oe("div",xk,[oe("div",Vk,[oe("span",null,Ze(u.value.known_for_department||"Film"),1),u.value.birthday?(Ee(),Ie("span",Mk,"Born "+Ze(u.value.birthday),1)):_n("",!0),u.value.place_of_birth?(Ee(),Ie("span",Lk,Ze(u.value.place_of_birth),1)):_n("",!0)]),oe("h2",Fk,Ze(u.value.name),1),oe("p",Uk,Ze(u.value.biography||"No biography available."),1),oe("div",jk,[te[10]||(te[10]=oe("p",{class:"section-kicker mb-1"},"Filmography",-1)),te[11]||(te[11]=oe("h3",{class:"h4 mb-3"},"Movies",-1)),w.value.length===0?(Ee(),Ie("div",$k," No movie credits found. ")):(Ee(),Ie("div",Bk,[(Ee(!0),Ie(fn,null,Ki(w.value,Se=>(Ee(),Ie("div",{key:Se.credit_id||Se.id,class:"col-6 col-md-4 col-lg-3 col-xl-2"},[Ln(Au,{movie:Se,"is-watchlisted":C(Se.id),onSelect:Kt,onToggleWatchlist:I},null,8,["movie","is-watchlisted"])]))),128))]))])])])):_n("",!0)])])):_n("",!0)])}}};WT(Hk).mount("#app");
